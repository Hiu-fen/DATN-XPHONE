...
function HotSaleSection() {
  return (
    <div className="bg-gradient-to-b from-red-600 to-red-500 text-white py-4 px-4 mx-36 rounded-lg">
        {/* Header */}
        ...
        <div className="bg-white text-black rounded p-2">
            {/* Container ảnh với group để hover */}
            <div className="bg-gray-200 mb-2 relative rounded overflow-hidden group" style={{ position: "relative" }}>
                ...
                />
            {/* Overlay icon mắt và trái tim, hiện khi hover bên phải */}
            <div
        ...
        <div className="text-center mt-4">  
            <button className="bg-red-500 text-white px-4 py-2 border rounded inline-flex items-center justify-center gap-2 hover:border-none transition-colors hover:bg-black ">
                Xem tất cả
                <FaArrowRight />
            </button>
        </div>
