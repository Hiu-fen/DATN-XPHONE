...
exports.createOrder = async (req, res) => {
  try {
    ...
    // 🔥 TẠO ĐỐI TƯỢNG ORDER VỚI CẢ TRƯỜNG CŨ VÀ MỚI
    const orderData = {
      orderCode,
    ...
    // 🔥 DEBUG: Log dữ liệu sẽ lưu vào database
    console.log("💾 SAVING TO DATABASE:")
    console.log("💾 orderData.ordererInfo:", orderData.ordererInfo)
    console.log("💾 orderData.recipientInfo:", orderData.recipientInfo)

    const order = new Order(orderData)
    await order.save()

    // 🔥 DEBUG: Log dữ liệu sau khi lưu
